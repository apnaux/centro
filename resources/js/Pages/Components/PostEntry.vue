    ...
    <div class="flex flex-col justify-end flex-shrink-0">
        <div class="border p-8 min-h-max w-[40rem] flex flex-col gap-y-4 justify-between">
                ...
                <div class="flex flex-row gap-x-4">
                    ...
                    <div class="flex flex-col">
                        <div>
                            ...
                            <p v-else>{{ post.user.name }} @{{ post.user.username }} (You)</p>
                        </div>
                        <div class="text-gray-400 text-sm flex flex-row gap-x-2 items-center">
                            <svg width="24" height="24" v-if="post.visibility == 'only me'" class="w-4" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <svg width="24" height="24" v-if="post.visibility == 'friends'" class="w-4" fill="none" viewBox="0 0 24 24"
                            ...
                            <svg width="24" height="24" v-if="post.visibility == 'public'" class="w-4" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <p>
                                {{ getDateString(post.created_at) }} <span
                                    v-if="calculateIfEdited(post.created_at, post.updated_at)">(edited)</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-row gap-x-4 items-center">
                ...
                <Link type="button" as="button" :href="'/post/' + post.id + '/delete'" method="delete"
                ...
                <button type="button" @click="edit.show()" v-if="post.user.id == $page.props.auth.user.id">
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <div class="border-x border-b max-h-96 w-[40rem] flex flex-col overflow-y-scroll" v-if="commentToggle" ref="box">
            <div class="flex flex-col gap-y-4 p-8">
                ...
                <Comments v-for="comment in commentsList.data" :postid="post.id" :comment="comment"
