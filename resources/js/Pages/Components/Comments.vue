    ...
    <div class="flex flex-row items-start justify-start gap-x-4">
        ...
        <div class="flex flex-col text-sm gap-y-1">
            ...
            <div class="flex flex-row gap-x-2">
                <Link as="button" type="button" method="delete" v-if="comment.is_liked"
                    :href="'/post/' + props.postid + '/comments/' + props.comment.id + '/unlike'">
                ...
                <Link as="button" type="button" method="post" v-else
                    :href="'/post/' + props.postid + '/comments/' + props.comment.id + '/like'">
                ...
                <Link type="button" as="button"
                    :href="'/post/' + props.postid + '/comments/' + props.comment.id + '/delete'" method="delete"
